...
welcome-page-message =
    Apa khabar, selamat datang ke Pelancar Permainan Anime Itu!

    We need to prepare some stuff and download default components before you could run the game


tos-violation-warning = Amaran pelanggaran Terma dan Syarat

tos-violation-warning-message =
    Pelancar ini bukanlah alat rasmi dan langsung tiada kaitan dengan {company-name} mahupun {company-alter-name}.

    Alat ini direka untuk memudahkkan {game-name} dimainkan dalam Linux dan dibuat dengan tujuan untuk mengurangkan sakit kepala ketika memasang dan menjalankan permainan itu.
